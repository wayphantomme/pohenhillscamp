/**
 * Static site data extracted from WordPress audit.
 * Source: https://moccasin-wombat-987069.hostingersite.com/
 */

export const SITE = {
  name: "Pohen Hills Camp",
  tagline: "Glamping in the heart of Bali's highlands",
  description:
  ...
  googleWriteReviewUrl:
    "https://search.google.com/local/writereview?placeid=ChIJo6YP7g-J0S0RrWyp_1uQWIo",
  googleRating: 4.7,
  googleReviewCount: 176,
  wpBaseUrl: "https://moccasin-wombat-987069.hostingersite.com",
  ssaBaseUrl: "https://moccasin-wombat-987069.hostingersite.com",
};
